...
LevelUP.prototype.get = function (key_, options, callback) {
  ...
  key = this._codec.encodeKey(key_, [options, self.options])

  options.asBuffer = this._codec.valueAsBuffer([options, self.options])
  console.log('GET OPTS', options, 'self.options', self.options)
  ...
  this.db.get(key, options, function (err, value) {
    ...
    if (callback) {
      try {
        value = self._codec.decodeValue(value, [options, self.options])
      } catch (e) {
...
LevelUP.prototype.put = function (key_, value_, options, callback) {
  ...
  options = getOptions(options)
  key     = this._codec.encodeKey(key_, [options, self.options])
  value   = this._codec.encodeValue(value_, [options, self.options])
  console.log('ENCODED VALUE', value, 'options', [options, self.options])
...
LevelUP.prototype.batch = function (arr_, options, callback) {
  ...
  options  = getOptions(options)
  var arr = self._codec.encodeBatch(arr_, [options, self.options]);
...
LevelUP.prototype.approximateSize = function (start_, end_, options, callback) {
  ...
  start = this._codec.encodeKey(start_, [options, this.options])
  end   = this._codec.encodeKey(end_, [options, this.options])
